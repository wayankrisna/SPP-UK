...
<section class="main">
    <h1><b>DATA SPP</b></h1>
    <br><br><br>
    <button class="kelas-tambah"><a href="dashboard.php?halaman=spp-tambah"> TAMBAH</a></button>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="button-aksi">
                                <button class="kelas-up"><a href="dashboard.php?halaman=spp-update&angkatan=<?php echo $rowkelas['angkatan'] ?>">EDIT</a></button>
                                <button class="kelas-del" onclick="return confirm('Yakin Ingin Menghapus Data Ini?')"><a href="delete/deletespp.php?angkatan=<?php echo $rowkelas['angkatan'] ?>">HAPUS</a></button>
